...
<head>
  ...
  <title>Kategori_Produk - RARASWIDYA</title>
            ...
            <div class="card-body">
              ...
              <form class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="kd_kat" name="nm_kat" required>
                </div>
                ...
                <div class="text-center">
                  ...
                  <button type="submit" class="btn btn-success" name="simpan">Simpan
                </div>
              </form><!-- Vertical Form -->
